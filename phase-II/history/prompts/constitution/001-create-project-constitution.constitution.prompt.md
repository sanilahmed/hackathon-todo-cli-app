...
links:
  ...
  pr: null
files:
  - /mnt/d/Hackathon/todo-app/phase-II/.specify/memory/constitution.md
tests:
  - None
---
...
-Spec-driven development:
  All implementation must strictly follow approved specifications.
-Agentic workflow compliance
  Mandatory flow:  
  spec → plan → tasks → implementation
  Manual coding is not allowed.
- Security-first design
  Authentication, authorization, and user isolation are enforced by default.
- Deterministic behavior
  APIs and UI must behave consistently across users and sessions.
